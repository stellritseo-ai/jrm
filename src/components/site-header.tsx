        ...
        >
          ...
          >
              ...
              {navItems.map((item) => {
                        ...
                        <div className="w-[220px] bg-[#23321e] p-6 text-left flex flex-col justify-between shrink-0 relative overflow-hidden">
                          ...
                          <div className="space-y-4 relative z-10">
                            ...
                            <h3 className="text-white text-sm font-black font-serif leading-snug">
                              Custom Hardscapes & Remodeling
                            </h3>
                            <p className="text-[#8fa886] text-[10px] font-light leading-relaxed">
                              35 years of trusted craftsmanship, license, and owner-led oversight in San Antonio, Texas.
                            </p>
                          </div>
                ...
                return (
                  <Link
                    ...
                    className={
                      isActive
                        ? "border border-[#577a4c]/40 px-4 py-1.5 rounded-full bg-white/80 backdrop-blur-md text-[15px] font-semibold text-[#3d5636] shadow-[0_2px_12px_rgba(87,122,76,0.06)]"
                        : "border border-transparent px-4 py-1.5 rounded-full flex items-center gap-1 text-[15px] font-medium text-neutral-800 hover:text-[#3d5636] hover:bg-[#577a4c]/8 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200"
                    }
                  >
                    {t(item.key)}
                  </Link>
            ...
            <div className="hidden lg:flex items-center gap-3">
              ...
              >
                <Phone className="h-3.5 w-3.5 fill-white text-white" />
                <span className="font-normal text-sm">{settings.officePhone}</span>
              </a>
            </div>
          </div>
        </div>
