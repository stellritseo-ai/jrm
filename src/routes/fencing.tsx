...
function FencingPage() {
  ...
  const fencingProcess = [
    ...
    },
    {
      ...
      desc: "Robert Thompson guides you through cedar grades, iron shapes, heights, and gate locks, ensuring alignment with your home's architecture."
    },
    {
      number: "03",
      ...
      <div className="w-full bg-[#f4f3ef] pt-[5px] pb-[5px] px-[15px]">
        <section className="relative mx-auto max-w-[1400px] w-full rounded-[10px] overflow-hidden border border-[#eae8e1] shadow-[0_12px_40px_rgb(0,0,0,0.06)] min-h-[420px] md:min-h-[500px] flex items-center justify-center text-center px-6 py-16">
          ...
          >
            ...
            >
              Custom Fencing Services in San Antonio
            </h1>

            {/* Subtitle */}
            <p className="mt-6 text-sm md:text-base text-neutral-300 font-light leading-relaxed max-w-3xl mx-auto">
              Define Your Space with Strength, Style & 35 Years of Craftsmanship
            </p>
          </motion.div>
          ...
          <div className="grid gap-12 lg:grid-cols-[1.3fr_1fr] lg:gap-20 items-center">
            ...
            >
              ...
              <p className="text-base text-neutral-700 leading-relaxed font-light first-letter:text-5xl first-letter:font-extrabold first-letter:text-[#3d5636] first-letter:float-left first-letter:mr-3 first-letter:mt-1">
                Your property's perimeter is its first line of defense, a statement of privacy, and a frame for its beauty. At JRM Construction Landscaping Design, we build custom fencing solutions that do more than mark a boundary—they enhance security, increase privacy, and elevate your property's curb appeal with enduring quality.
              </p>
              <p className="text-base text-neutral-700 leading-relaxed font-light">
                With over 35 years of experience in San Antonio, owner Robert Thompson understands that a great fence requires the perfect balance of aesthetic design, structural integrity, and practical function.
              </p>
              <p className="text-base text-neutral-700 leading-relaxed font-light">
            ...
            >
              ...
              <img
                src={imgFencing}
                alt="Premium vertical cedar board fence installed by JRM"
          ...
          <div className="grid gap-12 lg:grid-cols-[1fr_1.3fr] lg:gap-16 items-center">
            ...
            >
              ...
              <h2 
                ...
                style={{ fontFamily: "Georgia, serif" }}
              >
                Why Choose JRM for Your San Antonio Fence?
              </h2>
              <p className="text-base text-neutral-700 leading-relaxed font-light">
            ...
            <div className="bg-white/5 border border-white/10 backdrop-blur-md rounded-2xl p-8 w-full max-w-3xl mb-10 text-left">
              ...
              <div className="grid sm:grid-cols-2 gap-5 text-[15px] font-light">
                ...
                <div className="flex items-center gap-3.5">
                  ...
                  <span>Serving San Antonio, New Braunfels, Boerne, Seguin & surrounding areas</span>
                </div>
                <div className="flex items-center gap-3.5">
