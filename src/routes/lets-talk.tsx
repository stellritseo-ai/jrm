            ...
            >
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                ...
                >
                  ...
                  <p className="mt-3 text-md font-bold text-[#3d5636] group-hover:underline">{settings.officePhone}</p>
                </a>
          ...
          >
            ...
            <div className="bg-white/5 border border-white/10 backdrop-blur-md rounded-2xl p-8 w-full max-w-3xl mb-10 text-left">
              ...
              <div className="grid sm:grid-cols-2 gap-5 text-[15px] font-light">
                <a href={`tel:${phoneClean}`} className="flex items-center gap-3.5 hover:text-[#a5b89d] transition-colors">
                  <Phone className="w-5 h-5 text-[#a5b89d] shrink-0" />
                  <span>{settings.officePhone}</span>
                </a>
                <a href={`mailto:${settings.adminEmail}`} className="flex items-center gap-3.5 hover:text-[#a5b89d] transition-colors">
