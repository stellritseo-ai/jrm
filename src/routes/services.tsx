...
import imgAdu from "@/assets/svc-adu-services.jpg";
import imgStampedConcrete from "@/assets/svc-stamped-concrete.jpg";
...
function ServicesPage() {
  ...
  const servicesData = [
    ...
    },
    {
      ...
      image: imgAdu,
      badge: "🏡",
      desc: "Expand your property with a custom Accessory Dwelling Unit. Whether you need space for family, a rental unit for extra income, or a private office, we build premium ADUs that seamlessly integrate with your existing home and landscaping.",
      items: [
        "Detached Backyard Cottages",
        "Attached Guest Houses",
        "Garage Conversions & Additions",
        "Full-Service Permitting & Planning",
        "Owner-Led Construction Oversight"
      ],
      link: "/adu-services",
      linkText: "Learn More About ADU Services →"
    },
    {
      id: "fireplace",
      category: "residential",
    ...
    },
    {
      id: "stamped-concrete",
      category: "landscape",
      title: "Stamped Concrete / Overlay",
      icon: Layers,
      image: imgStampedConcrete,
      badge: "🧱",
      desc: "Elevate your property with durable, decorative concrete surfaces. Stamped concrete offers the look of premium natural stone, brick, slate, flagstone, or wood at a fraction of the cost, making it the perfect solution for driveways, walkways, pool decks, and patios.",
      items: [
        "Patios & Walkways",
        "Driveways & Courtyards",
        "Pool Decks & Surrounds",
        "Endless Stamp Patterns & Colors",
        "High-Performance Protective Sealers"
      ],
      link: "/stamped-concrete-overlay",
      linkText: "Learn More About Stamped Concrete →"
    },
    {
      id: "softscapes",
      category: "landscape",
    ...
    <div className="min-h-screen bg-[#f4f3ef] font-sans">
      ...
      <div className="w-full bg-[#f4f3ef] pt-[10px] pb-[10px] px-[15px]">
        <section 
          ...
          style={{ backgroundImage: `url(${welBg})`, backgroundSize: "cover", backgroundPosition: "center", backgroundAttachment: "fixed" }}
        >
          {/* Cards Grid */}
