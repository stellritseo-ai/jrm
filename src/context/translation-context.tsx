...
export function TranslationProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    const savedLanguage = localStorage.getItem("jrm-language") as Language;
...
export const translations = {
  en: {
    ...
    "services.irrigation": "IRRIGATION",
    ...
    "services.decks.desc": "Bespoke wooden and composite outdoor decks, balconies, multi-tier platforms, and built-in seating.",
    ...
    // Footer Section
    "footer.desc": "JRM Construction Landscaping Design, your trusted partner for premier remodeling and outdoor living in San Antonio. For over three and a half decades, principal & design consultant Robert Thompson and our skilled team have been dedicated to turning our clients' visions into stunning, lasting reality. We combine unparalleled craftsmanship with creative design to enhance both the beauty and value of your property.",
    "footer.title.col1": "JRM Construction Landscaping Design",
    "footer.title.services": "Services",
    "footer.title.links": "Quick Links",
    "footer.title.quickLinks": "Quick Links",
    ...
    "footer.contact.consultant": "Principal & Design Consultant : Robert Thompson",
    "footer.contact.robert": "Robert: (210) 429-5526",
    "footer.contact.arturo": "Arturo: (210) 379-3505",
    "footer.contact.email": "Email: robertsa210@icloud.com",
    "footer.contact.address": "Address: San Antonio, TX",
  ...
  es: {
    ...
    "services.decks.desc": "Decks de madera y compuestos a medida, balcones y plataformas multinivel.",
    ...
    // Get Started Section
    "getstarted.title": "Comience hoy su viaje de\ndiseño de construcción y paisajismo.",
    ...
    // Footer Section
    "footer.desc": "JRM Construction Landscaping Design, su socio de confianza para remodelación y vida al aire libre de primer nivel en San Antonio. Durante más de tres décadas y media, el consultor principal y de diseño Robert Thompson y nuestro capacitado equipo se han dedicado a convertir las visiones de nuestros clientes en una realidad impresionante y duradera. Combinamos una artesanía inigualable con un diseño creativo para mejorar tanto la belleza como el valor de su propiedad.",
    "footer.title.col1": "JRM Construction Landscaping Design",
    "footer.title.services": "Servicios",
    "footer.title.links": "Enlaces Rápidos",
    "footer.title.quickLinks": "Enlaces Rápidos",
    "footer.title.contact": "Contacte con Nosotros",
    "footer.phone": "Teléfono",
    "footer.email": "Correo Electrónico",
    "footer.address": "Dirección",
    "footer.service.1": "Remodelación de Casas",
    "footer.service.2": "Servicio de Nueva Construcción",
    "footer.service.3": "Chimeneas",
    "footer.service.4": "Cercas",
    "footer.service.5": "Patios y Concreto (Hardscape)",
    "footer.service.6": "Patios Techados",
    ...
    "footer.link.6": "Obtenga una Consulta Gratis",
    "footer.link.7": "Contacto",
    "footer.contact.consultant": "Consultor Principal y de Diseño: Robert Thompson",
    "footer.contact.robert": "Robert: (210) 429-5526",
    "footer.contact.arturo": "Arturo: (210) 379-3505",
    "footer.contact.email": "Correo Electrónico: robertsa210@icloud.com",
    "footer.contact.address": "Dirección: San Antonio, TX",
